...
Statime is a work in progress Rust implementation of PTP version 2.1 (IEEE 1588-2019). It currently implements support for acting as either an ordinary or a boundary clock. Note that we are planning a large refactor of the code base to deal with a number of issues, and that the public interface is likely to change with that.
