...
impl<'d> PTPClock<'d> {
    ...
    pub fn set_freq(&mut self, ppm_offset: f32) {
        // casting order is on purpose, this makes negative numbers such that adding with wrapping
        // results in an effective substraction on self.base_addend later
