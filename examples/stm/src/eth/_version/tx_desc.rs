...
use embassy_stm32::pac::ETH;
use vcell::VolatileCell;

use super::super::TX_BUFFER_SIZE;
...
impl<'a> TDesRing<'a> {
    ...
    pub(crate) fn transmit(&mut self, len: usize) {
        ...
        // Ensure changes to the descriptor are committed before DMA engine sees tail
        // pointer store. This will generate an DMB instruction.
        // "Preceding reads and writes cannot be moved past subsequent writes."
        fence(Ordering::Release);
